# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-08-15 03:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_children', to='blog.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
